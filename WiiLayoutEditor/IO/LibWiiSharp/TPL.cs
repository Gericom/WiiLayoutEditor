...
namespace libWiiSharp
{
    ...
    public class TPL : IDisposable
    {
		...
		public TPL_TextureHeader GetTextureHeader(int idx)
		{
			return tplTextureHeaders[idx];
		}
		...
		public byte[] ExtractTextureBitmapData(int index)
		{
			byte[] rgbaData;
			...
			try
			{
				...
				{
					case TPL_TextureFormat.I4:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.I4.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.I8:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.I8.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.IA4:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.IA4.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.IA8:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.IA8.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.RGB565:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.RGB565.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.RGB5A3:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.RGB5A3.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.RGBA8:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.Rgba32.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					case TPL_TextureFormat.CI4:
						rgbaData = fromCI4(textureData[index], paletteToRgba(index), tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight);
						break;
					...
					case TPL_TextureFormat.CI14X2:
						...
						break;
					case TPL_TextureFormat.CMP:
						rgbaData = Chadsoft.CTools.Image.ImageDataFormat.Cmpr.ConvertFrom(textureData[index], tplTextureHeaders[index].TextureWidth, tplTextureHeaders[index].TextureHeight, null);
						break;
					default:
						throw new FormatException("Unsupported Texture Format!");
				}
        ...
        private int textureByteSize(TPL_TextureFormat tplFormat, int width, int height)
        {
            switch (tplFormat)
            {
                ...
                case TPL_TextureFormat.CI14X2:
                    return Shared.AddPadding(width, 4) * Shared.AddPadding(height, 4) * 2;
                case TPL_TextureFormat.CMP:
					return Shared.AddPadding(width, 8) * Shared.AddPadding(height, 8);
                default:
                    throw new FormatException("Unsupported Texture Format!");
            }
        }
